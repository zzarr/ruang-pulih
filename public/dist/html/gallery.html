        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <div class="">
                        <h1 class="page-title fw-semibold fs-20 mb-0">Gallery</h1>
                        <div class="">
                            <nav>
               ...
               <!-- GALLERY DEMO OPEN -->
							<div class="demo-gallery card custom-card">
								...
								<div class="card-body">
									...
									<div class="row">
										...
										<div class="col-lg-3 col-md-3 col-sm-6 col-12">
											<a href="../assets/images/media/7.jpg" class="glightbox card" data-gallery="gallery1">
												<img src="../assets/images/media/7.jpg" alt="image" >
											</a>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-6 col-12">
											<a href="../assets/images/media/8.jpg" class="glightbox card" data-gallery="gallery1">
												<img src="../assets/images/media/8.jpg" alt="image" >
											</a>
										</div>
									</div>
									<!--End::row-1 -->

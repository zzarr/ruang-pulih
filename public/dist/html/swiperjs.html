        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <div class="">
                        <h1 class="page-title fw-semibold fs-20 mb-0">Swiper</h1>
                        <div class="">
                            <nav>
                            ...
                            <div class="card-body">
                                <div class="swiper swiper-basic">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide"><img src="../assets/images/media/7.jpg" alt=""></div>
                                        <div class="swiper-slide"><img src="../assets/images/media/6.jpg" alt=""></div>
                                        <div class="swiper-slide"><img src="../assets/images/media/5.jpg" alt=""></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <div class="swiper swiper-navigation">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide"><img src="../assets/images/media/9.jpg" alt=""></div>
                                        <div class="swiper-slide"><img src="../assets/images/media/8.jpg" alt=""></div>
                                        <div class="swiper-slide"><img src="../assets/images/media/5.jpg" alt=""></div>
                                    </div>
                        ...
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <div class="swiper pagination">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide"><img src="../assets/images/media/2.jpg" alt=""></div>
                                        <div class="swiper-slide"><img src="../assets/images/media/1.jpg" alt=""></div>
                                        <div class="swiper-slide"><img src="../assets/images/media/3.jpg" alt=""></div>
                                    </div>
                        ...
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <div class="swiper swiper-fade">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img src="../assets/images/media/8.jpg" alt="img">
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="../assets/images/media/9.jpg" alt="img">
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="../assets/images/media/5.jpg" alt="img">
                                        </div>
                                    </div>
                                    <div class="swiper-button-next"></div>
                                    <div class="swiper-button-prev"></div>
                        ...
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <div class="swiper swiper-overflow">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img class="img-fluid" src="../assets/images/media/5.jpg" alt="img">
                                        </div>
                                        <div class="swiper-slide">
                                            <img class="img-fluid" src="../assets/images/media/1.jpg" alt="img">
                                        </div>
                                        <div class="swiper-slide">
                                            <img class="img-fluid" src="../assets/images/media/2.jpg" alt="img">
                                        </div>
                                        <div class="swiper-slide">
                                            <img class="img-fluid" src="../assets/images/media/3.jpg" alt="img">
                                        </div>
                                        <div class="swiper-slide">
                                            <img class="img-fluid" src="../assets/images/media/4.jpg" alt="img">
                                        </div>
                                        <div class="swiper-slide">
                                            <img class="img-fluid" src="../assets/images/media/9.jpg" alt="img">
                                        </div>
                                        <div class="swiper-slide">
                                            <img class="img-fluid" src="../assets/images/media/6.jpg" alt="img">
                                        </div>
                                        <div class="swiper-slide">
                                            <img class="img-fluid" src="../assets/images/media/1.jpg" alt="img">
                                        </div>
                            ...
                            <div class="card-body">
                                <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper swiper-preview">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide ratio ratio-21x9 ">
                                            <img class="img-fluid rounded" src="../assets/images/media/1.jpg" alt="img">
                                        </div>
                                        <div class="swiper-slide ratio ratio-21x9">
                                            <img class="img-fluid rounded" src="../assets/images/media/2.jpg" alt="img">
                                        </div>
                                        <div class="swiper-slide ratio ratio-21x9">
                                            <img class="img-fluid rounded" src="../assets/images/media/3.jpg" alt="img">
                                        </div>
                                        <div class="swiper-slide ratio ratio-21x9">
                                            <img class="img-fluid rounded" src="../assets/images/media/4.jpg" alt="img">
                                        </div>
                                        <div class="swiper-slide ratio ratio-21x9">
                                            <img class="img-fluid rounded" src="../assets/images/media/5.jpg" alt="img">
                                        </div>
                                        <div class="swiper-slide ratio ratio-21x9">
                                            <img class="img-fluid rounded" src="../assets/images/media/6.jpg" alt="img">
                                        </div>
                                        <div class="swiper-slide ratio ratio-21x9">
                                            <img class="img-fluid rounded" src="../assets/images/media/7.jpg" alt="img">
                                        </div>
                                    </div>
                                    <div class="swiper-button-next"></div>
                                    <div class="swiper-button-prev"></div>
                                ...
                                <div class="swiper swiper-view">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <img class="img-fluid" src="../assets/images/media/7.jpg" alt="img">
                                        </div>
                                    </div>
                                </div>
                            </div>

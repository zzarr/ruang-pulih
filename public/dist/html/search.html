		...
		<div class="main-content app-content">
			<div class="container-fluid">
				...
				<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
				    <div class="">
				        <h1 class="page-title fw-semibold fs-20 mb-0">Search</h1>
				        <div class="">
				            <nav>
									...
									<div class="card-body">
										<div class="form-group">
											...
											<select class="form-control" data-trigger name="choices-single-default"
												...
												<option value="Choice 3">Men's Groming</option>
												<option value="Choice 3">Accessories</option>
											</select>
										</div>
										<div class="form-group mt-3">
											...
											<select class="form-control" data-trigger name="choices-single-default"
												...
												<option value="Choice 2">Top wear</option>
												<option value="Choice 3">Beuty Groming</option>
												<option value="Choice 3">Accessories</option>
												<option value="Choice 3">jewellery</option>
											</select>
										</div>
										<div class="form-group mt-3">
											...
											<select class="form-control" data-trigger name="choices-single-default"
												...
												<option value="Choice 3">Baby Care</option>
												<option value="Choice 3">Kids footwear</option>
											</select>
										</div>
										<div class="form-group mt-3">
											...
											<select class="form-control" data-trigger name="choices-single-default"
												...
												<option value="Choice 3">Health care Appliances</option>
											</select>
										</div>
										<div class="form-group mt-3">
											...
											<select class="form-control" data-trigger name="choices-single-default"
												...
												<option value="Choice 3">Music</option>
											</select>
										</div>
										<a href="javascript:void(0)" class="btn btn-primary d-grid mt-4">Submit</a>
									</div>
								</div>
							</div>
							<div class="col-md-12 col-lg-6 col-xl-12">
								<div class="card custom-card">
									<div class="card-body h-100">
										...
										<div class="card-subtitle text-center">Upto 50% Discount slaes Every shopping
											items</div>
										<div class="text-center">
											<div class="mt-3 ">
												<a href="javascript:void(0)" class="btn btn-primary d-grid"> View
													More</a>
											</div>
											<div class="mt-3 d-grid">
												<a href="cart.html" class="btn btn-secondary"><i class="fe fe-plus"></i>
													Add to cart</a>
											</div>
										</div>
									</div>
					...
					<div class="col-lg-12 col-xl-9">
						<div class="input-group">
							...
							<div class="input-group-text btn btn-primary">
								<i class="fe fe-search fw-bold fs-16" aria-hidden="true"></i>
							</div>
						</div>
						<div class="card mt-4 users store">
							<div class="table-responsive">
								<table class="table card-table table-vcenter text-nowrap">
									<tr>
										<td><span class="avatar avatar-md rounded-circle mt-1"
												style="background-image: url(../assets/images/faces/1.jpg)"></span></td>
										<td>Mens Jackets</td>
										<td>
											<div>
												...
												<i class="ri-star-fill text-warning fs-18"></i>
												<i class="ri-star-fill text-warning fs-18"></i>
												<i class="ri-star-fill text-light  fs-18"></i>
											</div>
										</td>
										<td class="text-end text-primary d-none d-md-table-cell text-nowrap">50% off
										</td>
										<td class="text-end">
											<strong>$1,987</strong>
										</td>
										<td class="text-end">
											<a href="javascript:void(0);" class="btn btn-primary-light btn-sm">view</a>
										</td>
									</tr>
									<tr>
										<td><span class="avatar avatar-md rounded-circle mt-1"
												style="background-image: url(../assets/images/faces/2.jpg)"></span></td>
									...
									<tr>
										<td><span class="avatar avatar-md rounded-circle mt-1"
												style="background-image: url(../assets/images/faces/5.jpg)"></span></td>
										<td>Saree
										...
										<td class="text-end text-warning d-none d-md-table-cell text-nowrap">25% off
										</td>
										<td class="text-end">
											<strong>$999</strong>
										</td>
									...
									<tr>
										<td><span class="avatar avatar-md rounded-circle mt-1"
												style="background-image: url(../assets/images/faces/4.jpg)"></span></td>
										<td>Western Wear</td>
										<td>
											<div>
												<i class="ri-star-fill text-warning fs-18"></i>
									...
									<tr>
										<td><span class="avatar avatar-md rounded-circle mt-1"
												style="background-image: url(../assets/images/faces/14.jpg)"></span>
										</td>
										<td>Kids Dress
										...
										<td class="text-end text-primary d-none d-md-table-cell text-nowrap">47% off
										</td>
										<td class="text-end">
											<strong>$399</strong>
										</td>
									...
									<tr>
										<td><span class="avatar avatar-md rounded-circle mt-1"
												style="background-image: url(../assets/images/faces/11.jpg)"></span>
										</td>
										<td>Kids Toys</td>
										<td>
											<div>
										...
										<td class="text-end text-success d-none d-md-table-cell text-nowrap">26% off
										</td>
										<td class="text-end">
											<strong>$299</strong>
										</td>
									...
									<tr>
										...
										<td class="text-end text-warning d-none d-md-table-cell text-nowrap">43% off
										</td>
										<td class="text-end">
									...
									<tr>
										<td><span class="avatar avatar-md rounded-circle mt-1"
												style="background-image: url(../assets/images/faces/13.jpg)"></span>
										</td>
									...
									<tr>
										<td><span class="avatar avatar-md rounded-circle mt-1"
												style="background-image: url(../assets/images/faces/12.jpg)"></span>
										</td>
										<td>Novel Books
											<div class="badge bg-default badge-md">New</div>
										</td>
										...
										<td class="text-end text-primary d-none d-md-table-cell text-nowrap">14% off
										</td>
										<td class="text-end">
											<strong>$899</strong>
										</td>
									...
									<tr>
										<td class="border-bottom-0"><span class="avatar avatar-md rounded-circle mt-1"
												style="background-image: url(../assets/images/faces/1.jpg)"></span></td>
										<td class="border-bottom-0">Welcare Fitness</td>
										...
										<td class="text-end text-success d-none d-md-table-cell text-nowrap border-bottom-0">40% off
										</td>

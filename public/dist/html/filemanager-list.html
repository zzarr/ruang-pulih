		...
		<div class="main-content app-content">
			<div class="container-fluid">
				...
				<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
				    <div class="">
				        <h1 class="page-title fw-semibold fs-20 mb-0">File Manager List</h1>
				        <div class="">
				            <nav>
				...
				<div class="row row-sm">
					<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6">
						<div class="card overflow-hidden custom-card">
							<a href="filemanager-details.html" class="mx-auto my-3"><img
									src="../assets/images/media/files/10.png" alt="img"></a>
					...
					<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6">
						<div class="card overflow-hidden custom-card">
							<a href="filemanager-details.html"><img src="../assets/images/media/files/7.jpg" alt="img"
					...
					<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6">
						<div class="card overflow-hidden custom-card">
							<a href="filemanager-details.html" class="mx-auto my-3"><img
									src="../assets/images/media/files/9.png" alt="img"></a>
							<div class="card-footer">
								<div class="d-flex">
									<div class="">
					...
					<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6">
						<div class="card overflow-hidden custom-card">
							<a href="filemanager-details.html"><img src="../assets/images/media/files/2.jpg" alt="img"
									class="w-100 file-manager-list"></a>
							<div class="card-footer">
								<div class="d-flex">
									<div class="">
					...
					<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6">
						<div class="card overflow-hidden custom-card">
							<a href="filemanager-details.html" class="mx-auto my-3"><img
									src="../assets/images/media/files/11.png" alt="img"></a>
							<div class="card-footer">
								<div class="d-flex">
									<div class="">
					...
					<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6">
						<div class="card overflow-hidden custom-card">
							<a href="filemanager-details.html" class="mx-auto my-3"><img
									src="../assets/images/media/files/12.png" alt="img"></a>
							<div class="card-footer">
								<div class="d-flex">
									<div class="">
					...
					<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6">
						<div class="card overflow-hidden custom-card">
							<a href="filemanager-details.html"><img src="../assets/images/media/files/4.jpg" alt="img"
									class="w-100 file-manager-list"></a>
							<div class="card-footer">
								<div class="d-flex">
									<div class="">
					...
					<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6">
						<div class="card overflow-hidden custom-card">
							<a href="filemanager-details.html" class="mx-auto my-3"><img
									src="../assets/images/media/files/13.png" alt="img"></a>
							<div class="card-footer">
								<div class="d-flex">
									<div class="">
					...
					<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6">
						<div class="card overflow-hidden custom-card">
							<a href="filemanager-details.html"><img src="../assets/images/media/files/1.jpg" alt="img"
									class="w-100 file-manager-list"></a>
							<div class="card-footer">
								<div class="d-flex">
									<div class="">
					...
					<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6">
						<div class="card overflow-hidden custom-card">
							<a href="filemanager-details.html"><img src="../assets/images/media/files/6.jpg" alt="img"
									class="w-100 file-manager-list"></a>
							<div class="card-footer">
								<div class="d-flex">
									<div class="d-flex">
										<h6 class="mb-0 fw-semibold text-break">image3.jpg</h6>
									</div>
									<div class="ms-auto my-auto">
										<span class="text-muted mb-0">76 KB</span>
									</div>
					...
					<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6">
						<div class="card overflow-hidden custom-card">
							<a href="filemanager-details.html"><img src="../assets/images/media/files/5.jpg" alt="img"
									class="w-100 file-manager-list"></a>
							<div class="card-footer">
								<div class="d-flex">
									<div class="">
										<h6 class="mb-0 fw-semibold text-break">image4.jpg</h6>
									</div>
									<div class="ms-auto my-auto">
										<span class="text-muted mb-0">66 KB</span>
									</div>
					...
					<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-4 col-sm-6">
						<div class="card overflow-hidden custom-card">
							<a href="filemanager-details.html" class="mx-auto my-3"><img
									src="../assets/images/media/files/14.png" alt="img"></a>
							<div class="card-footer">
								<div class="d-flex">
									<div class="">

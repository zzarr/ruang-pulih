		...
		<div class="main-content app-content">
			<div class="container-fluid">
				...
				<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
				    <div class="">
				        <h1 class="page-title fw-semibold fs-20 mb-0">File Details</h1>
				        <div class="">
				            <nav>
					...
					<div class="col-xl-8 col-lg-12 col-md-12">
						<div class="card custom-card overflow-hidden">
							<div class="card-body p-3">
								<a href="javascript:void(0)"><img src="../assets/images/media/files/8.jpg" alt="img" class="br-5 w-100"></a>
							</div>
						</div>
						<div class="card custom-card overflow-hidden">
							<div class="card-body">
					...
					<div class="col-xl-4 col-lg-12 col-md-12">
						...
						<div class="card custom-card">
							<div class="card-body pb-2">
								...
								<div class="row">
									<div class="col-xs-4 col-sm-4 col-md-4 col-xl-4  my-1 border-bottom-0">
										<a href="gallery.html">
											<img class=" br-5 w-100 mb-3" src="../assets/images/media/files/1.jpg" alt="Thumb-1">
										</a>
									</div>
									<div class="col-xs-4 col-sm-4 col-md-4 col-xl-4 my-1 border-bottom-0">
										<a href="gallery.html">
											<img class=" br-5 w-100 mb-3" src="../assets/images/media/files/2.jpg" alt="Thumb-1">
										</a>
									</div>
									<div class="col-xs-4 col-sm-4 col-md-4 col-xl-4 my-1 border-bottom-0">
										<a href="gallery.html">
											<img class=" br-5 w-100 mb-3" src="../assets/images/media/files/3.jpg" alt="Thumb-1">
										</a>
									</div>
									<div class="col-xs-4 col-sm-4 col-md-4 col-xl-4 my-1 border-bottom-0">
										<a href="gallery.html">
											<img class=" br-5 w-100 mb-3" src="../assets/images/media/files/4.jpg" alt="Thumb-1">
										</a>
									</div>
									<div class="col-xs-4 col-sm-4 col-md-4 col-xl-4 my-1 border-bottom-0">
										<a href="gallery.html">
											<img class=" br-5 w-100 mb-3" src="../assets/images/media/files/5.jpg" alt="Thumb-1">
										</a>
									</div>
									<div class="col-xs-4 col-sm-4 col-md-4 col-xl-4 my-1 border-bottom-0">
										<a href="gallery.html">
											<img class=" br-5 w-100 mb-3" src="../assets/images/media/files/6.jpg" alt="Thumb-1">
										</a>
									</div>
								</div>
							</div>

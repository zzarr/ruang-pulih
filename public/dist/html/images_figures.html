            ...
            <div class="main-content app-content">
                <div class="container-fluid">
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <div class="">
                            <h1 class="page-title fw-semibold fs-20 mb-0">Images & Figures</h1>
                            <div class="">
                                <nav>
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        <img src="../assets/images/media/4.jpg" class="img-fluid" alt="...">
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        <img src="../assets/images/media/9.jpg" class="img-fluid rounded" alt="...">
                                    </div>
                                </div>
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        <img src="../assets/images/media/5.jpg" class="img-fluid rounded-pill" alt="...">
                                    </div>
                                </div>
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <img class="rounded float-start w-100" src="../assets/images/media/5.jpg" alt="...">
                                </div>
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-html"><code class="language-html">&lt;img class="rounded float-start w-100" src="../assets/images/media/5.jpg" alt="..."&gt;</code></pre>
<!-- Prism Code -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <img class="rounded mx-auto d-block w-100" src="../assets/images/media/5.jpg" alt="...">
                                </div>
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-html"><code class="language-html">&lt;img class="rounded mx-auto d-block w-100" src="../assets/images/media/5.jpg" alt="..."&gt;</code></pre>
<!-- Prism Code -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <img class="rounded float-end w-100" src="../assets/images/media/4.jpg" alt="...">
                                </div>
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-html"><code class="language-html">&lt;img class="rounded float-end w-100" src="../assets/images/media/4.jpg" alt="..."&gt;</code></pre>
<!-- Prism Code -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-body d-flex justify-content-between gap-2">
                                    <figure class="figure">
                                        <img class="bd-placeholder-img figure-img img-fluid rounded card-img" src="../assets/images/media/6.jpg" alt="...">
                                        <figcaption class="figure-caption">A caption for the above image.
                                        </figcaption>
                                    </figure>
                                    <figure class="figure float-end">
                                        <img class="bd-placeholder-img figure-img img-fluid rounded card-img" src="../assets/images/media/7.jpg" alt="...">
                        ...
                        <div class="col-xl-3">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        <img src="../assets/images/media/1.jpg" class="img-thumbnail" alt="...">
                                    </div>
                                </div>
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
                        ...
                        <div class="col-xl-3">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        <img src="../assets/images/media/2.jpg" class="img-thumbnail rounded-pill" alt="...">
                                    </div>
                                </div>
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->

        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <div class="">
                        <h1 class="page-title fw-semibold fs-20 mb-0"> Services</h1>
                        <div class="">
                            <nav>
							...
							<div class="row">
									...
									<div class="card service">
										<div class="card-body">
											<div class="item-box text-center">
												<div class=" text-center  mb-1 text-primary"><i class="ri-group-line"></i></div>
								...
								<div class="col-sm-12 col-md-12 col-lg-6 col-xl-3">
									<div class="card service">
										<div class="card-body">
											<div class="item-box text-center">
												<div class=" text-center text-danger mb-1 "><i class="ri-timer-2-line"></i></div>
												<div class="item-box-wrap">
								...
								<div class="col-sm-12 col-md-12 col-lg-6 col-xl-3">
									<div class="card service">
										<div class="card-body">
											<div class="item-box text-center">
												<div class=" text-center text-success mb-1 "><i class="ri-building-4-line"></i></div>
												<div class="item-box-wrap">
								...
								<div class="col-sm-12 col-md-12 col-lg-6 col-xl-3">
									<div class="card service">
										<div class="card-body">
											<div class="item-box text-center">
												<div class="text-center text-warning mb-1 "><i class="ri-share-forward-line"></i></div>
												<div class="item-box-wrap">
											...
											<div class="row">
												<div class="col-xl-2 col-lg-3 feature">
													<div class="fa-stack fa-lg fa-1x border btn-primary mb-3">
														<i class="ri-earth-fill fa-stack-1x fs-20"></i>
													</div>
												</div>
												<div class="col-xl-10 col-lg-9">
													<div class="mt-1">
														<h6 class="fw-semibold">Web design</h6>
											...
											<div class="row">
												<div class="col-xl-2 col-lg-3 feature">
													<div class="fa-stack fa-lg fa-1x border bg-warning mb-3">
														<i class="ri-building-4-line fa-stack-1x fs-20"></i>
													</div>
												</div>
												<div class="col-xl-10 col-lg-9">
													<div class="mt-1">
											...
											<div class="row">
												<div class="col-xl-2 col-lg-3 feature">
													<div class="fa-stack fa-lg fa-1x border bg-pink mb-3">
														<i class="ri-file-word-line fa-stack-1x fs-20"></i>
													</div>
												</div>
												<div class="col-xl-10 col-lg-9">
													<div class="mt-1">
														<h6 class="fw-semibold">Wordpress</h6>
														<p class="mb-0">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
														The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here',
														making it look like readable English.</p>
													</div>
											...
											<div class="row">
												<div class="col-xl-2 col-lg-3 feature">
													<div class="fa-stack fa-lg fa-1x border bg-danger mb-3">
														<i class="ri-camera-fill fa-stack-1x fs-20"></i>
													</div>
												</div>
												<div class="col-xl-10 col-lg-9">
													<div class="mt-1">
														<h6 class="fw-semibold">photography</h6>
														<p class="mb-0">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
														The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here',
														making it look like readable English.</p>
													</div>
											...
											<div class="row">
												<div class="col-xl-2 col-lg-3 feature">
													<div class="fa-stack fa-lg fa-1x border bg-purple mb-3">
														<i class="ri-edit-box-line  fa-stack-1x fs-20"></i>
													</div>
												</div>
												<div class="col-xl-10 col-lg-9">
													<div class="mt-1">
											...
											<div class="row">
												<div class="col-xl-2 col-lg-3 feature">
													<div class="fa-stack fa-lg fa-1x border bg-success mb-3">
														<i class="ri-firefox-fill fa-stack-1x fs-20"></i>
													</div>
												</div>
												<div class="col-xl-10 col-lg-9">
													<div class="mt-1">
														<h6 class="fw-semibold">Android</h6>
														<p class="mb-0">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
														The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here',
														making it look like readable English.</p>
													</div>
											...
											<div class="text-wrap">
												...
												<div class="row mt-3">
													...
													<div class="col-md-6">
														...
														<div class="progress progress-md mb-3">
															<div class="progress-bar  bg-pink w-80">80%</div>
														</div>
													</div>
													<div class="col-md-6">
														<label>Photography</label>
														<div class="progress progress-md mb-3">
															<div class="progress-bar bg-danger w-75">75%</div>
														</div>
													</div>
													<div class="col-md-6">
														<label>Development</label>
														<div class="progress progress-md mb-3 mb-md-0">
															<div class="progress-bar bg-purple w-65">65%</div>
														</div>
													</div>
													<div class="col-md-6">
														<label>Android</label>

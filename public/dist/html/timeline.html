		...
		<div class="main-content app-content">
			<div class="container-fluid">
				...
				<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
				    <div class="">
				        <h1 class="page-title fw-semibold fs-20 mb-0"> Timeline</h1>
				        <div class="">
				            <nav>
					...
					<div class="col-lg-12">
						<div class="card custom-card">
							<div class="card-header border-bottom-0 custom-card-header">
								<h6 class="main-content-label mb-0 fs-14">Vertical Timeline</h6>
							</div>
							<div class="card-body">
								<div class="vtimeline">
										...
										<div class="timeline-panel">
											...
											<div class="timeline-footer d-flex align-items-center flex-wrap">
												...
												<span class="ms-md-auto"><i
														class="fe fe-calendar text-muted mx-1"></i>19 Oct 2020</span>
											</div>
										</div>
									</div>
									<div class="timeline-wrapper timeline-inverted timeline-wrapper-secondary">
										...
										<div class="timeline-panel">
											...
											<div class="timeline-footer d-flex align-items-center flex-wrap">
												...
												<span>25</span>
												<span class="ms-md-auto"><i
														class="fe fe-calendar text-muted mx-1"></i>10th Oct 2020</span>
											</div>
										</div>
									</div>
									<div class="timeline-wrapper timeline-wrapper-info">
										...
										<div class="timeline-panel">
											...
											<div class="timeline-footer d-flex align-items-center flex-wrap">
												...
												<span>19</span>
												<span class="ms-md-auto"><i
														class="fe fe-calendar text-muted mx-1"></i>5th Oct 2020</span>
											</div>
										</div>
									</div>
										...
										<div class="timeline-panel">
											...
											<div class="timeline-body">
												<p>Pianoforte principles our unaffected not for astonished travelling
													are particular.</p>
												<img src="../assets/images/media/1.jpg" class="mb-3 br-5 w-100" alt="img">
											</div>
											<div class="timeline-footer d-flex align-items-center flex-wrap">
												<i class="fe fe-heart  text-muted mx-1"></i>
												<span>19</span>
												<span class="ms-md-auto"><i
														class="fe fe-calendar text-muted mx-1"></i>27th Sep 2017</span>
											</div>
										</div>
									</div>
									<div class="timeline-wrapper timeline-wrapper-success">
										...
										<div class="timeline-panel">
											...
											<div class="timeline-footer d-flex align-items-center flex-wrap">
												...
												<span>25</span>
												<span class="ms-md-auto"><i
														class="fe fe-calendar text-muted mx-1"></i>25th Sep 2017</span>
											</div>
										</div>
									</div>
										...
										<div class="timeline-panel">
											...
											<div class="timeline-body">
												<div class="embed-responsive embed-responsive-16by9 mb-3">
													<iframe class="embed-responsive-item br-5 w-100"
											...
											<div class="timeline-footer d-flex align-items-center flex-wrap">
												...
												<span>32</span>
												<span class="ms-md-auto"><i
														class="fe fe-calendar text-muted mx-1"></i>19th Sep 2017</span>
											</div>
										</div>
									</div>
									<div class="timeline-wrapper timeline-wrapper-dark">
										...
										<div class="timeline-panel">
											...
											<div class="timeline-footer d-flex align-items-center flex-wrap">
												...
												<span>26</span>
												<span class="ms-md-auto"><i
														class="fe fe-calendar text-muted mx-1"></i>15th Sep 2017</span>
											</div>
										</div>
									</div>
								</div>

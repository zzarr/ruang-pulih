        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <div class="">
                        <h1 class="page-title fw-semibold fs-20 mb-0">Ratings</h1>
                        <div class="">
                            <nav>
                ...
                <div class="row">
                        ...
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap align-items-center justify-content-between">
                                    <p class="fs-14 mb-0 fw-normal">Show Some <span class="text-danger">&#10084;</span> with rating :</p>
                    ...
                    <div class="col-xxl-4 col-xl-6">
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap align-items-center justify-content-between">
                                    <p class="fs-14 mb-0 fw-normal">Dont forget to rate the product :</p>
                    ...
                    <div class="col-xxl-4 col-xl-12">
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap align-items-center justify-content-between">
                                    <p class="fs-14 mb-0 fw-normal">Your rating is much appreciated&#128079; :</p>
                    ...
                    <div class="col-xxl-6 col-xl-6">
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap align-items-center justify-content-between">
                                    <p class="fs-14 mb-0 fw-normal">Thanks for rating :</p>
                    ...
                    <div class="col-xxl-4 col-xl-6">
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap align-items-center justify-content-between">
                                    <p class="fs-14 mb-0 fw-normal">Please give your valuable rating :</p>
                    ...
                    <div class="col-xxl-4 col-xl-6">
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap align-items-center justify-content-between">
                                    <p class="fs-14 mb-0 fw-normal">Thank You so much for your support :</p>
                                    <div class="d-flex flex-wrap align-items-center">

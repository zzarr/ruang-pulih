		...
		<div class="main-content app-content">
			<div class="container-fluid">
				...
				<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
				    <div class="">
				        <h1 class="page-title fw-semibold fs-20 mb-0">Mail-Compose</h1>
				        <div class="">
				            <nav>
						...
						<div class="card custom-card">
							<div class="list-group list-group-transparent mb-0 mail-inbox pb-3">
								<div class="mt-4 mb-4 mx-4 text-center">
									<a href="email.html" class="btn btn-primary btn-lg d-grid">Inbox</a>
								</div>
					...
					<div class="col-lg-8 col-xl-9 col-md-12 col-sm-12">
						<div class="card custom-card">
							...
							<div class="card-footer d-sm-flex">
								<div class="my-auto">
									<a href="javascript:void(0)" class="btn btn-outline-light me-1" data-bs-toggle="tooltip" title="" data-bs-original-title="Attach"><span class="ri-attachment-2 align-bottom"></span></a>
									<a href="javascript:void(0)" class="btn btn-outline-light me-1" data-bs-toggle="tooltip" title="" data-bs-original-title="Link"><span class="ri-link align-bottom"></span></a>
									<a href="javascript:void(0)" class="btn btn-outline-light me-1" data-bs-toggle="tooltip" title="" data-bs-original-title="Photos"><span class="ri-image-line align-bottom"></span></a>
									<a href="javascript:void(0)" class="btn btn-outline-light me-1" data-bs-toggle="tooltip" title="" data-bs-original-title="Delete"><span class="ri-delete-bin-line align-bottom"></span></a>
								</div>

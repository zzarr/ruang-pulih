        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <div class="">
                        <h1 class="page-title fw-semibold fs-20 mb-0">User List</h1>
                        <div class="">
                            <nav>
								...
								<div class="col-lg-12 col-xl-12">
									<div class="input-group mb-4">
										...
										<div class="input-group-text btn btn-primary">
											<i class="fe fe-search fw-bold" aria-hidden="true"></i>
										</div>
									</div>
									<div class="card custom-card">
										<div class="card-header border-bottom-0 p-4">
											<h2 class="card-title">1 - 30 of 546 users</h2>
											<div class="page-options d-flex ms-auto">
												<div class="w-180">
												...
												<table class="table border table-bordered mb-0">
													...
													<tbody>
														<tr>
															...
															<td class="align-middle text-center"><img alt="image" class="avatar avatar-md br-7" src="../assets/images/faces/16.jpg"></td>
															<td class="text-nowrap align-middle">Adam Cotter</td>
															<td class="text-nowrap align-middle"><span>09 Dec 2017</span></td>

															<td class="text-center align-middle btn-list">
																<button class="btn btn-icon btn-primary-light btn-wave waves-effect waves-light">
                                                                    <i class="ri-edit-fill"></i>
                                                                </button>
																<button class="btn btn-icon btn-danger-light btn-wave waves-effect waves-light">
														...
														<tr>
															...
															<td class="align-middle text-center"><img alt="image" class="avatar avatar-md br-7" src="../assets/images/faces/15.jpg"></td>
														...
														<tr>
															...
															<td class="align-middle text-center"><img alt="image" class="avatar avatar-md br-7" src="../assets/images/faces/4.jpg"></td>
														...
														<tr>
															...
															<td class="align-middle text-center"><img alt="image" class="avatar avatar-md br-7" src="../assets/images/faces/1.jpg"></td>
														...
														<tr>
															...
															<td class="align-middle text-center"><img alt="image" class="avatar avatar-md br-7" src="../assets/images/faces/19.jpg"></td>
														...
														<tr>
															...
															<td class="align-middle text-center"><img alt="image" class="avatar avatar-md br-7" src="../assets/images/faces/8.jpg"></td>
														...
														<tr>
															...
															<td class="align-middle text-center"><img alt="image" class="avatar avatar-md br-7" src="../assets/images/faces/12.jpg"></td>
